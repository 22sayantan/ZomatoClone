		...
		$('#checkout').click(function(){
			...
			$.ajax({
				...
				success:function(data){
					...
					window.location.href = "http://localhost/zomato/show_address.php?order_id=" + data;
				},
			...
			<div class="card">
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-12">
							<button id="checkout" class="btn bg-danger btn-block text-white mt-2">Checkout</button>
						</div>
					</div>
				</div>
